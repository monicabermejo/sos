...
export const UI_STRINGS = {
  ...
  helpSteps: {
    ca: [
      { icon: 'fa-island-tropical', title: 'La missió', desc: 'Has naufragat en una illa deserta! Resol les 9 equacions per aconseguir recursos de supervivència i ser rescatat.' },
      { icon: 'fa-calculator', title: 'Com respondre', desc: 'Escriu el valor de x al camp de text i prem Enviar (o la tecla Enter). Per respostes múltiples, separa els valors amb comes: 6, 24.' },
      { icon: 'fa-lightbulb', title: 'Pistes de la IA', desc: 'Escriu "pista" o fes clic al botó Pista per rebre ajuda pas a pas generada per intel·ligència artificial.' },
      { icon: 'fa-list', title: 'Menú de missions', desc: 'Fes clic a ☰ per veure totes les missions. Només pots accedir a la missió actual o les ja completades; la resta estan bloquejades fins que avancis.' },
      { icon: 'fa-map', title: 'Mapa de l\'illa', desc: 'El panell dret mostra el mapa. Cada recurs aconseguit apareix marcat. La barra de progrés indica quantes missions has completat.' },
      { icon: 'fa-calendar-days', title: 'Dies de supervivència', desc: 'El comptador de dies augmenta un dia per cada missió resolta, reflectint el temps passat a l\'illa.' },
      { icon: 'fa-language', title: 'Canvi d\'idioma', desc: 'Fes clic a CA / ES a la capçalera per canviar entre català i castellà en qualsevol moment.' },
      { icon: 'fa-rotate-left', title: 'Reiniciar partida', desc: 'Fes clic al botó 🔄 de la capçalera per reiniciar tot el progrés des de zero. Se\'t demanarà confirmació.' },
      { icon: 'fa-trophy', title: 'Final del joc', desc: 'Quan resolgueu la missió 9, un modal celebratoriu apareixerà. Podràs revisar tot el xat o iniciar una nova aventura.' },
    ],
    es: [
      { icon: 'fa-island-tropical', title: 'La misión', desc: '¡Has naufragado en una isla desierta! Resuelve las 9 ecuaciones para conseguir recursos de supervivencia y ser rescatado.' },
      { icon: 'fa-calculator', title: 'Cómo responder', desc: 'Escribe el valor de x en el campo de texto y pulsa Enviar (o la tecla Enter). Para respuestas múltiples, separa los valores con comas: 6, 24.' },
      { icon: 'fa-lightbulb', title: 'Pistas de la IA', desc: 'Escribe "pista" o haz clic en el botón Pista para recibir ayuda paso a paso generada por inteligencia artificial.' },
      { icon: 'fa-list', title: 'Menú de misiones', desc: 'Haz clic en ☰ para ver todas las misiones. Solo puedes acceder a la misión actual o las ya completadas; el resto están bloqueadas hasta que avances.' },
      { icon: 'fa-map', title: 'Mapa de la isla', desc: 'El panel derecho muestra el mapa. Cada recurso conseguido aparece marcado. La barra de progreso indica cuántas misiones has completado.' },
      { icon: 'fa-calendar-days', title: 'Días de supervivencia', desc: 'El contador de días aumenta un día por cada misión resuelta, reflejando el tiempo pasado en la isla.' },
      { icon: 'fa-language', title: 'Cambio de idioma', desc: 'Haz clic en CA / ES en la cabecera para cambiar entre catalán y castellano en cualquier momento.' },
      { icon: 'fa-rotate-left', title: 'Reiniciar partida', desc: 'Haz clic en el botón 🔄 de la cabecera para reiniciar todo el progreso desde cero. Se te pedirá confirmación.' },
      { icon: 'fa-trophy', title: 'Final del juego', desc: 'Al resolver la misión 9, aparecerá un modal celebratorio. Podrás revisar todo el chat o iniciar una nueva aventura.' },
    ],
  },
  rescued: {
