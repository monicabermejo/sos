...
export const UI_STRINGS = {
  ...
  helpSteps: {
    ca: [
      ...
      { icon: 'fa-lightbulb', title: 'Pistes', desc: 'Escriu "pista" o fes clic al botó Pista per rebre ajuda pas a pas.' },
      ...
      { icon: 'fa-map', title: 'Mapa de l\'illa', desc: 'El panell esquerre mostra el mapa. Cada recurs aconseguit apareix marcat. La barra de progrés indica quantes missions has completat.' },
      ...
      { icon: 'fa-trophy', title: 'Final del joc', desc: 'Un cop completat el joc, tindràs la opció de revisar les missions o iniciar de nou l\'aventura.' },
    ],
    es: [
      ...
      { icon: 'fa-lightbulb', title: 'Pistas', desc: 'Escribe "pista" o haz clic en el botón Pista para recibir ayuda paso a paso.' },
      ...
      { icon: 'fa-map', title: 'Mapa de la isla', desc: 'El panel izquierdo muestra el mapa. Cada recurso conseguido aparece marcado. La barra de progreso indica cuántas misiones has completado.' },
      ...
      { icon: 'fa-trophy', title: 'Final del juego', desc: 'Una vez completado el juego, tendrás la opción de revisar las misiones o iniciar de nuevo la aventura.' },
    ],
  },
  rescued: {
